...
void firstPage()
{
    cout << "\n___________________________________________________________________________________" << endl;
        cout << "____________________________WELCOME TO Indian RAILWAYS______________________________" << endl
             << endl;
    ...
    case 3:
    {
        ...
        cout << "___________________Thanks for using Indian Railways_____________________" << endl
             << endl;
        exit(0);
    }
    }
...
public:
    ...
    void dispBill()
    {
        ...
        cout << "____Indian Railways_____" << endl;
